...
var inlite = (function () {
  ...
  var $_451680174jhbq2d2f = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_ekbbf3178jhbq2d2k.fromClientRect(clientRect)) : null;
  };
  var $_gclxp0177jhbq2d2i = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_eeygw9176jhbq2d2h.result(predicateIds[i].id, $_gclxp0177jhbq2d2i.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_eeygw9176jhbq2d2h.result(predicateIds[x].id, $_gclxp0177jhbq2d2i.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_eeygw9176jhbq2d2h.result(id, $_gclxp0177jhbq2d2i.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_eeygw9176jhbq2d2h.result(id, $_gclxp0177jhbq2d2i.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_6pafx417hjhbq2d2u.isArray(value)) {
      return value;
    } else if ($_6pafx417hjhbq2d2u.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_6pafx417hjhbq2d2u.isBoolean(value)) {
  ...
  var $_7f8bs17gjhbq2d2t = {
    getStringOr: getByTypeOr($_6pafx417hjhbq2d2u.isString),
    getBoolOr: getByTypeOr($_6pafx417hjhbq2d2u.isBoolean),
    getNumberOr: getByTypeOr($_6pafx417hjhbq2d2u.isNumber),
    getHandlerOr: getByTypeOr($_6pafx417hjhbq2d2u.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_6pafx417hjhbq2d2u.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_ekbbf3178jhbq2d2k.toClientRect(targetRect),
        contentAreaRect: $_ekbbf3178jhbq2d2k.toClientRect(contentAreaRect),
        panelRect: $_ekbbf3178jhbq2d2k.toClientRect(panelRect)
      });
      return $_ekbbf3178jhbq2d2k.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_7f8bs17gjhbq2d2t.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_7f8bs17gjhbq2d2t.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_7f8bs17gjhbq2d2t.getHandlerOr(editor, 'inline_toolbar_position_handler', $_dbs1zb17ijhbq2d2w.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_2dk22j17djhbq2d2q.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_di7xgb17ejhbq2d2r.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_di7xgb17ejhbq2d2r.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_as71n417cjhbq2d2o = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_451680174jhbq2d2f.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_cf4t40179jhbq2d2l.fromContextToolbars(toolbars);
    result = $_eeygw9176jhbq2d2h.match(editor, [
      $_2z5udj175jhbq2d2g.element(elements[0], contextToolbarsPredicateIds),
      $_gfh5xm17bjhbq2d2n.textSelection('text'),
      $_gfh5xm17bjhbq2d2n.emptyTextBlock(elements, 'insert'),
      $_2z5udj175jhbq2d2g.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_eeygw9176jhbq2d2h.match(editor, [$_gfh5xm17bjhbq2d2n.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_as71n417cjhbq2d2o.load(editor, function () {
  ...
  var $_eu0jyr170jhbq2d2a = { renderUI: renderUI };
  ...
  var never$1 = $_2cr60f17njhbq2d3h.never;
  var always$1 = $_2cr60f17njhbq2d3h.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_2cr60f17njhbq2d3h.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_fhk41917ojhbq2d3j.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_a5kpau17ljhbq2d37 = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_baenlt17vjhbq2d4l.parseBox(settings.border);
      self.paddingBox = $_baenlt17vjhbq2d4l.parseBox(settings.padding);
      self.marginBox = $_baenlt17vjhbq2d4l.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_cnbkf5183jhbq2d5a.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_baenlt17vjhbq2d4l.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_baenlt17vjhbq2d4l.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_baenlt17vjhbq2d4l.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_1u8vok182jhbq2d59.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_cnbkf5183jhbq2d5a.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_cnbkf5183jhbq2d5a.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_18b24j184jhbq2d5f = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_cnbkf5183jhbq2d5a.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_cnbkf5183jhbq2d5a.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_a5kpau17ljhbq2d37.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_a5kpau17ljhbq2d37.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_baenlt17vjhbq2d4l.parseBox(self.settings.border);
          ...
          self.borderBox = $_baenlt17vjhbq2d4l.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_eu0jyr170jhbq2d2a.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_6qvclg16zjhbq2d28 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_gf790p18njhbq2d7k.resolve(name, scope);
  };
  ...
  var $_f0hexm18mjhbq2d7g = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_f0hexm18mjhbq2d7g.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_8zzv4k18kjhbq2d7a = { blobToBase64: blobToBase64 };
  ...
  var $_8btdli18qjhbq2d7n = { pickFile: pickFile };
  ...
  var $_7x0dul18sjhbq2d7s = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_2x6zjd18ujhbq2d7w.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_2x6zjd18ujhbq2d7w.resolve(dom, bookmark));
  };
  ...
  var $_89zxct18tjhbq2d7u = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_7x0dul18sjhbq2d7s.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_89zxct18tjhbq2d7u.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_g15xo418rjhbq2d7p.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_8btdli18qjhbq2d7n.pickFile().then(function (files) {
          var blob = files[0];
          $_8zzv4k18kjhbq2d7a.blobToBase64(blob).then(function (base64) {
            $_g15xo418rjhbq2d7p.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_g15xo418rjhbq2d7p.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_a77ara18jjhbq2d78 = { addToEditor: addToEditor };
  ...
  var $_ghfzhx18yjhbq2d8b = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_73e585190jhbq2d8g.isAbsolute(href) && $_73e585190jhbq2d8g.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_g15xo418rjhbq2d7p.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_g15xo418rjhbq2d7p.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_rj46a18zjhbq2d8e = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_6pafx417hjhbq2d2u.isArray(items)) {
      return items;
    } else if ($_6pafx417hjhbq2d2u.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_6pafx417hjhbq2d2u.isFunction(button)) {
            button = button();
          }
  ...
  var $_4td4t3191jhbq2d8h = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_4td4t3191jhbq2d8h.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_4td4t3191jhbq2d8h.create(editor, 'text', $_di7xgb17ejhbq2d2r.getTextSelectionToolbarItems(editor)),
        $_4td4t3191jhbq2d8h.create(editor, 'insert', $_di7xgb17ejhbq2d2r.getInsertToolbarItems(editor)),
        $_rj46a18zjhbq2d8e.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_di7xgb17ejhbq2d2r.getPositionHandler(editor);
      contentAreaRect = $_gclxp0177jhbq2d2i.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_dbs1zb17ijhbq2d2w.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_dbs1zb17ijhbq2d2w.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_ghfzhx18yjhbq2d8b.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_dbs1zb17ijhbq2d2w.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_gclxp0177jhbq2d2i.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_dbs1zb17ijhbq2d2w.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_dbs1zb17ijhbq2d2w.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_2dk22j17djhbq2d2q.fireBeforeRenderUI(editor);
  ...
  var $_ebq4y019ojhbq2day = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_2cr60f17njhbq2d3h.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_r51de19pjhbq2db0 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_f1n5wg19tjhbq2dbq = { cached: cached };

  var $_ao1wyu19vjhbq2dbt = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_ao1wyu19vjhbq2dbt.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_ao1wyu19vjhbq2dbt.ELEMENT);
  var isText = isType$2($_ao1wyu19vjhbq2dbt.TEXT);
  var isDocument = isType$2($_ao1wyu19vjhbq2dbt.DOCUMENT);
  var $_f95zpe19ujhbq2dbr = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_f95zpe19ujhbq2dbr.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_f1n5wg19tjhbq2dbq.cached(function () {
    return getBody($_r51de19pjhbq2db0.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_r51de19pjhbq2db0.fromDom(body);
  };
  var $_71or9y19sjhbq2dbi = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_a5kpau17ljhbq2d37.each(fields, function (name, i) {
        struct[name] = $_2cr60f17njhbq2d3h.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_fhk41917ojhbq2d3j.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_a5kpau17ljhbq2d37.each(array, function (a) {
      if (!$_fhk41917ojhbq2d3j.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_a5kpau17ljhbq2d37.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_8kz5re1a1jhbq2dcv.validateStrArr('required', required);
    $_8kz5re1a1jhbq2dcv.validateStrArr('optional', optional);
    $_8kz5re1a1jhbq2dcv.checkDupes(everything);
    return function (obj) {
      var keys = $_fadltn1a0jhbq2dcq.keys(obj);
      var allReqd = $_a5kpau17ljhbq2d37.forall(required, function (req) {
        return $_a5kpau17ljhbq2d37.contains(keys, req);
      });
      if (!allReqd)
        $_8kz5re1a1jhbq2dcv.reqMessage(required, keys);
      var unsupported = $_a5kpau17ljhbq2d37.filter(keys, function (key) {
        return !$_a5kpau17ljhbq2d37.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_8kz5re1a1jhbq2dcv.unsuppMessage(unsupported);
      var r = {};
      $_a5kpau17ljhbq2d37.each(required, function (req) {
        r[req] = $_2cr60f17njhbq2d3h.constant(obj[req]);
      });
      $_a5kpau17ljhbq2d37.each(optional, function (opt) {
        r[opt] = $_2cr60f17njhbq2d3h.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_6113zp19xjhbq2dck = {
    immutable: Immutable,
  ...
  var $_cq9f3r1a2jhbq2dcy = { toArray: toArray };

  var node = function () {
    var f = $_f0hexm18mjhbq2d7g.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_ccwl4q1a8jhbq2ddt.unknown()
    });
  };
  ...
  var $_8igjmm1a7jhbq2ddn = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_2cr60f17njhbq2d3h.constant(edge),
    chrome: $_2cr60f17njhbq2d3h.constant(chrome),
    ie: $_2cr60f17njhbq2d3h.constant(ie),
    opera: $_2cr60f17njhbq2d3h.constant(opera),
    firefox: $_2cr60f17njhbq2d3h.constant(firefox),
    safari: $_2cr60f17njhbq2d3h.constant(safari)
  };
  ...
  var $_8onp6h1a9jhbq2ddv = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_2cr60f17njhbq2d3h.constant(windows$1),
    ios: $_2cr60f17njhbq2d3h.constant(ios),
    android: $_2cr60f17njhbq2d3h.constant(android),
    linux: $_2cr60f17njhbq2d3h.constant(linux),
    osx: $_2cr60f17njhbq2d3h.constant(osx),
    solaris: $_2cr60f17njhbq2d3h.constant(solaris),
    freebsd: $_2cr60f17njhbq2d3h.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_2cr60f17njhbq2d3h.constant(isiPad),
      isiPhone: $_2cr60f17njhbq2d3h.constant(isiPhone),
      isTablet: $_2cr60f17njhbq2d3h.constant(isTablet),
      isPhone: $_2cr60f17njhbq2d3h.constant(isPhone),
      isTouch: $_2cr60f17njhbq2d3h.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_2cr60f17njhbq2d3h.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_a5kpau17ljhbq2d37.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_ccwl4q1a8jhbq2ddt.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_ccwl4q1a8jhbq2ddt.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_35230q1aejhbq2den.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_35230q1aejhbq2den.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_35230q1aejhbq2den.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_35230q1aejhbq2den.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_2zhzvc1afjhbq2dep.head(str).bind(function (head) {
      return $_2zhzvc1afjhbq2dep.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_g0kqz01adjhbq2del.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_g0kqz01adjhbq2del.contains(uastring, 'edge/') && $_g0kqz01adjhbq2del.contains(uastring, 'chrome') && $_g0kqz01adjhbq2del.contains(uastring, 'safari') && $_g0kqz01adjhbq2del.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_g0kqz01adjhbq2del.contains(uastring, 'chrome') && !$_g0kqz01adjhbq2del.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_g0kqz01adjhbq2del.contains(uastring, 'msie') || $_g0kqz01adjhbq2del.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_g0kqz01adjhbq2del.contains(uastring, 'safari') || $_g0kqz01adjhbq2del.contains(uastring, 'mobile/')) && $_g0kqz01adjhbq2del.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_g0kqz01adjhbq2del.contains(uastring, 'iphone') || $_g0kqz01adjhbq2del.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_e3beco1acjhbq2dea = {
    browsers: $_2cr60f17njhbq2d3h.constant(browsers),
    oses: $_2cr60f17njhbq2d3h.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_e3beco1acjhbq2dea.browsers();
    var oses = $_e3beco1acjhbq2dea.oses();
    var browser = $_9jqf8y1abjhbq2de4.detectBrowser(browsers, userAgent).fold($_8igjmm1a7jhbq2ddn.unknown, $_8igjmm1a7jhbq2ddn.nu);
    var os = $_9jqf8y1abjhbq2de4.detectOs(oses, userAgent).fold($_8onp6h1a9jhbq2ddv.unknown, $_8onp6h1a9jhbq2ddv.nu);
  ...
  var $_aimvnf1a6jhbq2ddm = { detect: detect$2 };

  var detect$3 = $_f1n5wg19tjhbq2dbq.cached(function () {
    var userAgent = navigator.userAgent;
    return $_aimvnf1a6jhbq2ddm.detect(userAgent);
  });
  var $_87on341a5jhbq2ddh = { detect: detect$3 };

  var ELEMENT = $_ao1wyu19vjhbq2dbt.ELEMENT;
  var DOCUMENT = $_ao1wyu19vjhbq2dbt.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_a5kpau17ljhbq2d37.map(base.querySelectorAll(selector), $_r51de19pjhbq2db0.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_r51de19pjhbq2db0.fromDom);
  };
  var $_ff0vu1agjhbq2deq = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_a5kpau17ljhbq2d37.exists(elements, $_2cr60f17njhbq2d3h.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_779jsz1a4jhbq2ddg.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_87on341a5jhbq2ddh.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_8fnerl1a3jhbq2dd0 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_ff0vu1agjhbq2deq.is
  };

  var owner = function (element) {
    return $_r51de19pjhbq2db0.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_r51de19pjhbq2db0.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_r51de19pjhbq2db0.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_r51de19pjhbq2db0.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_a5kpau17ljhbq2d37.findIndex(kin, function (elem) {
        return $_8fnerl1a3jhbq2dd0.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_fhk41917ojhbq2d3j.isFunction(isRoot) ? isRoot : $_2cr60f17njhbq2d3h.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_r51de19pjhbq2db0.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_a5kpau17ljhbq2d37.filter(elements, function (x) {
        return !$_8fnerl1a3jhbq2dd0.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_r51de19pjhbq2db0.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_r51de19pjhbq2db0.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_r51de19pjhbq2db0.fromDom);
  };
  var prevSiblings = function (element) {
    return $_a5kpau17ljhbq2d37.reverse($_cq9f3r1a2jhbq2dcy.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_cq9f3r1a2jhbq2dcy.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_a5kpau17ljhbq2d37.map(dom.childNodes, $_r51de19pjhbq2db0.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_r51de19pjhbq2db0.fromDom);
  };
  ...
  var spot = $_6113zp19xjhbq2dck.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_3ueo6b19wjhbq2dbu = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_71or9y19sjhbq2dbi.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_a5kpau17ljhbq2d37.filter($_3ueo6b19wjhbq2dbu.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_a5kpau17ljhbq2d37.filter($_3ueo6b19wjhbq2dbu.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_a5kpau17ljhbq2d37.filter($_3ueo6b19wjhbq2dbu.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_a5kpau17ljhbq2d37.each($_3ueo6b19wjhbq2dbu.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_ff0vu1agjhbq2deq.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_4gpai419rjhbq2dbc.ancestors(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_4gpai419rjhbq2dbc.siblings(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_4gpai419rjhbq2dbc.children(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_ff0vu1agjhbq2deq.all(selector, scope);
  };
  var $_7nuszh19qjhbq2dba = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_a5kpau17ljhbq2d37.map($_7nuszh19qjhbq2dba.descendants($_r51de19pjhbq2db0.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_ebq4y019ojhbq2day.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_2cr60f17njhbq2d3h.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_a5kpau17ljhbq2d37.map($_a5kpau17ljhbq2d37.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_a5kpau17ljhbq2d37.map($_a5kpau17ljhbq2d37.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_a5kpau17ljhbq2d37.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_f1worp19njhbq2dae = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_2cr60f17njhbq2d3h.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_a5kpau17ljhbq2d37.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_a5kpau17ljhbq2d37.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_a5kpau17ljhbq2d37.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_a5kpau17ljhbq2d37.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_a5kpau17ljhbq2d37.indexOf(items, url).isNone()) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_f1worp19njhbq2dae.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_fhk41917ojhbq2d3j.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_71or9y19sjhbq2dbi.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_r51de19pjhbq2db0.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_r51de19pjhbq2db0.fromDom(element.parentNode), function (x) {
      return !$_8fnerl1a3jhbq2dd0.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_a5kpau17ljhbq2d37.find(scope.dom().childNodes, $_2cr60f17njhbq2d3h.compose(predicate, $_r51de19pjhbq2db0.fromDom));
    return result.map($_r51de19pjhbq2db0.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_r51de19pjhbq2db0.fromDom(element.childNodes[i])))
          return Option.some($_r51de19pjhbq2db0.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_ff0vu1agjhbq2deq.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_bhd2mz1amjhbq2dfl.ancestor(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_bhd2mz1amjhbq2dfl.sibling(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_bhd2mz1amjhbq2dfl.child(scope, function (e) {
      return $_ff0vu1agjhbq2deq.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_ff0vu1agjhbq2deq.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_ff0vu1agjhbq2deq.is, ancestor$1, scope, selector, isRoot);
  };
  var $_a4zc8t1aljhbq2dfk = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_wa7821aojhbq2dge = { register: register };
  ...
  var $_f8aqaa1aqjhbq2dgi = { register: register$1 };
  ...
  var $_4rxs1n1arjhbq2dgm = { register: register$2 };
  ...
  var $_ddelwp1asjhbq2dgp = { register: register$3 };
  ...
  var $_atjgmy1atjhbq2dgv = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_a5kpau17ljhbq2d37.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_a5kpau17ljhbq2d37.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_a5kpau17ljhbq2d37.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_ccrgq1aujhbq2dgy = { register: register$5 };
  ...
  var $_3c4tsi1avjhbq2dh4 = { register: register$6 };
  ...
  var $_cymzl91awjhbq2dha = { register: register$7 };
  ...
  var $_2styhl1axjhbq2dhc = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_a4zc8t1aljhbq2dfk.descendant($_r51de19pjhbq2db0.fromDom(document.body), editor.settings.ui_container).fold($_2cr60f17njhbq2d3h.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_atjgmy1atjhbq2dgv.register(editor);
    $_wa7821aojhbq2dge.register(editor);
    $_3c4tsi1avjhbq2dh4.register(editor);
    $_cymzl91awjhbq2dha.register(editor);
    $_4rxs1n1arjhbq2dgm.register(editor);
    $_f8aqaa1aqjhbq2dgi.register(editor);
    $_ddelwp1asjhbq2dgp.register(editor);
    $_2styhl1axjhbq2dhc.register(editor);
    $_ccrgq1aujhbq2dgy.register(editor);
  };
  var $_fk2saa1akjhbq2dfc = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_fhk41917ojhbq2d3j.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_fhk41917ojhbq2d3j.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_1u8vok182jhbq2d59,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_1sd8cw18gjhbq2d6z,
      Panel: Panel,
      Movable: $_18b24j184jhbq2d5f,
      Resizable: $_2z3y6018hjhbq2d73,
      ...
      FormatControls: $_fk2saa1akjhbq2dfc,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_fk2saa1akjhbq2dfc.setup(editor);
    $_a77ara18jjhbq2d78.addToEditor(editor, panel);
    return $_6qvclg16zjhbq2d28.get(editor, panel);
  });
  function Theme () {
  }
