...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_4nwldaisjhbq258f.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_4nwldaisjhbq258f.getPreviewDialogWidth(editor);
    var dialogHeight = $_4nwldaisjhbq258f.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_id4hmitjhbq258h.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_ebdivkiqjhbq258d = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_ebdivkiqjhbq258d.open(editor);
    });
  };
  var $_a05408ipjhbq258c = { register: register };
  ...
  var $_c7xrw9ivjhbq258k = { register: register$1 };

  global.add('preview', function (editor) {
    $_a05408ipjhbq258c.register(editor);
    $_c7xrw9ivjhbq258k.register(editor);
  });
  function Plugin () {
  }
