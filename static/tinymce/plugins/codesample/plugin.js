...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_ejfmj8a1jhbq23rz.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_cy9qt39xjhbq23qm.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_5p4wjo9zjhbq23qo.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_1qoq5ca2jhbq23s1 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_2c352h9wjhbq23qk = {
    open: function (editor) {
      var minWidth = $_cy9qt39xjhbq23qm.getDialogMinWidth(editor);
      var minHeight = $_cy9qt39xjhbq23qm.getDialogMinHeight(editor);
      var currentLanguage = $_1qoq5ca2jhbq23s1.getCurrentLanguage(editor);
      var currentLanguages = $_1qoq5ca2jhbq23s1.getLanguages(editor);
      var currentCode = $_5p4wjo9zjhbq23qo.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_5p4wjo9zjhbq23qo.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_ejfmj8a1jhbq23rz.isCodeSample(node)) {
        $_2c352h9wjhbq23qk.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_2xfx8l9vjhbq23qj = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_ejfmj8a1jhbq23rz.trimArg($_ejfmj8a1jhbq23rz.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_ejfmj8a1jhbq23rz.trimArg($_ejfmj8a1jhbq23rz.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_b0vexfa3jhbq23s3 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_cy9qt39xjhbq23qm.getContentCss(editor);
  ...
  var $_9rd3wda4jhbq23s6 = { loadCss: loadCss };
  ...
  var $_3x6p3ma5jhbq23s7 = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_b0vexfa3jhbq23s3.setup(editor);
    $_3x6p3ma5jhbq23s7.register(editor);
    $_2xfx8l9vjhbq23qj.register(editor);
    editor.on('init', function () {
      $_9rd3wda4jhbq23s6.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_ejfmj8a1jhbq23rz.isCodeSample(ev.target)) {
        $_2c352h9wjhbq23qk.open(editor);
      }
    });
  });
