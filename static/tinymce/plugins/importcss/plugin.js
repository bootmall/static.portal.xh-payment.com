...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_1dbpskerjhbq24nh.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_1dbpskerjhbq24nh.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_1dbpskerjhbq24nh.getSelectorConverter(editor)) {
      selectorConverter = $_1dbpskerjhbq24nh.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_1dbpskerjhbq24nh.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_1dbpskerjhbq24nh.getCssGroups(editor));
      ...
      if (!$_1dbpskerjhbq24nh.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_1dbpskerjhbq24nh.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_f987kvemjhbq24n9.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_dmj4fxeljhbq24n6 = { get: get };

  global.add('importcss', function (editor) {
    $_f987kvemjhbq24n9.setup(editor);
    return $_dmj4fxeljhbq24n6.get(editor);
  });
  function Plugin () {
  }
