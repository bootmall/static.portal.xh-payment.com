...
var contextmenu = (function () {
  ...
  var $_79gg5agjhbq23u7 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_cootm6afjhbq23u5.getContextMenu(editor);
  ...
  var $_1mr4ikajjhbq23ub = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_cootm6afjhbq23u5.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_1mr4ikajjhbq23ub.show(editor, $_79gg5agjhbq23u7.getPos(editor, e), visibleState, menu);
    });
  };
  var $_8tu6iyaejhbq23u4 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_8tu6iyaejhbq23u4.setup(editor, visibleState, menu);
    return $_cq7pyuadjhbq23u2.get(visibleState);
  });
  function Plugin () {
  }
