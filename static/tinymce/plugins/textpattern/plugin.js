...
var textpattern = (function () {
  ...
  var $_kv972r3jhbq27uz = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_cofrw1rbjhbq27vc.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_cofrw1rbjhbq27vc.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_cofrw1rbjhbq27vc.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_8untz6r8jhbq27v7.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_8untz6r8jhbq27v7.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_8untz6r8jhbq27v7.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_1hotdsr7jhbq27v4.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_1hotdsr7jhbq27v4.checkKeyCode(keyCodes, e)) {
        $_1hotdsr7jhbq27v4.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_1hotdsr7jhbq27v4.checkCharCode(charCodes, e)) {
  ...
  var $_deidvgr4jhbq27v1 = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_kv972r3jhbq27uz.getPatterns(editor.settings));
    $_deidvgr4jhbq27v1.setup(editor, patternsState);
    return $_fgw7anr2jhbq27ux.get(patternsState);
  });
  function Plugin () {
  }
