...
var wordcount = (function () {
  ...
  var $_7kz52ksrjhbq2858 = {
    each: each,
    map: map
  };

  var SETS$1 = $_7nwy1spjhbq2853.SETS;
  var OTHER = $_7nwy1spjhbq2853.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_7kz52ksrjhbq2858.map(string.split(''), memoized);
  };
  var $_h9i4sqjhbq2856 = { classify: classify };

  var ci = $_7nwy1spjhbq2853.characterIndices;
  ...
  var $_cqy1cassjhbq2859 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_7nwy1spjhbq2853.EMPTY_STRING;
  var WHITESPACE$1 = $_7nwy1spjhbq2853.WHITESPACE;
  var PUNCTUATION$1 = $_7nwy1spjhbq2853.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_h9i4sqjhbq2856.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_cqy1cassjhbq2859.isWordBoundary(map, i)) {
  ...
  var $_4dxmi6sojhbq2850 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_4dxmi6sojhbq2850.getWords(getTextContent(editor)).length;
  };
  var $_eqqljxsnjhbq284z = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_eqqljxsnjhbq284z.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_32b1sxsmjhbq284y = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_eqqljxsnjhbq284z.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_bzy2crstjhbq285c = { setup: setup };

  global.add('wordcount', function (editor) {
    $_bzy2crstjhbq285c.setup(editor);
    return $_32b1sxsmjhbq284y.get(editor);
  });
  function Plugin () {
  }
