...
var help = (function () {
  ...
  var never$1 = $_f6w866b4jhbq23wr.never;
  var always$1 = $_f6w866b4jhbq23wr.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_f6w866b4jhbq23wr.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_207k75b5jhbq23wv.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_2w0i57b2jhbq23we = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_aldee5b7jhbq23x1 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_2w0i57b2jhbq23we.map($_aldee5b7jhbq23x1.shortcuts, function (shortcut) {
  ...
  var $_41hzqfb1jhbq23w6 = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_355xv3bcjhbq23xy.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_355xv3bcjhbq23xy.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_355xv3bcjhbq23xy.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_355xv3bcjhbq23xy.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_dk62q7bdjhbq23y0.head(str).bind(function (head) {
      return $_dk62q7bdjhbq23y0.tail(str).map(function (tail) {
  ...
  var $_9p9blvbejhbq23y2 = { urls: urls };

  var makeLink = $_f6w866b4jhbq23wr.curry($_amg0o6bbjhbq23xs.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_2w0i57b2jhbq23we.find($_9p9blvbejhbq23y2.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_dwwz1rbajhbq23xj.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_2w0i57b2jhbq23we.filter(keys, $_f6w866b4jhbq23wr.not($_f6w866b4jhbq23wr.curry($_2w0i57b2jhbq23we.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_2w0i57b2jhbq23we.map(pluginKeys, function (key) {
  ...
  var $_3qu57ib9jhbq23x4 = { makeTab: makeTab$1 };
  ...
  var $_gctjsfbfjhbq23y8 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_41hzqfb1jhbq23w6.makeTab(),
          $_3qu57ib9jhbq23x4.makeTab(editor)
        ],
        buttons: $_gctjsfbfjhbq23y8.makeRow(),
  ...
  var $_c7fzokb0jhbq23w2 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_c7fzokb0jhbq23w2.open(editor, pluginUrl));
  };
  var $_3t2gx0azjhbq23w1 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_c7fzokb0jhbq23w2.open(editor, pluginUrl)
    });
  ...
  var $_arz4rbbhjhbq23ya = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_arz4rbbhjhbq23ya.register(editor, pluginUrl);
    $_3t2gx0azjhbq23w1.register(editor, pluginUrl);
