...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_wuwxw8qjhbq23m8.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_wuwxw8qjhbq23m8.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_wuwxw8qjhbq23m8.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_wuwxw8qjhbq23m8.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_wuwxw8qjhbq23m8.getAutoResizeBottomMargin(editor);
    ...
    if ($_wuwxw8qjhbq23m8.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_g5atrb8njhbq23m3.resize(editor, oldSize);
    });
  };
  var $_kadxt8mjhbq23lz = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_kadxt8mjhbq23lz.register(editor, oldSize);
      $_g5atrb8njhbq23m3.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
