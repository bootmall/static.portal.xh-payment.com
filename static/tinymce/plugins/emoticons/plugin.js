...
var emoticons = (function () {
  ...
  var $_6djri7avjhbq23vn = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_6djri7avjhbq23vn.getHtml(pluginUrl);
  ...
  var $_7h4cq9aujhbq23vl = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_7h4cq9aujhbq23vl.register(editor, pluginUrl);
  });
  function Plugin () {
  }
